function info = gs_iteration(A,varargin) 
% coupled algorithms based on als and asvd, i.e., gauss-seidel iteration
...
%         lambda = ttv(A,v,1:N);
        ...
        res_v(i) = res;
        fprintf("%d-th gals iteration: lambda is %f, residual is %7.1e\n",i,lambda,res);
...
%             lambda = ttv(A,v,1:N);
            ...
            res_v(i) = res;
            fprintf("%d-th gasvd iteration: lambda is %f, residual is %7.1e\n",i,lambda,res);
